...
print '<button type="submit" class="seup-btn seup-btn-primary" id="saveEditBtn">';
print '<i class="fas fa-save me-2"></i>Spremi';
print '</button>';
print '</div>';
print '</form>';
print '</div>';
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('editOtpremaForm').addEventListener('submit', function(e) {
        e.preventDefault();
